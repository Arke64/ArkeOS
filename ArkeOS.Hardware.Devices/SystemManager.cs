...
namespace ArkeOS.Hardware.Devices {
	public class SystemManager {
		...
		public SystemManager() {
			...
			this.SystemBusController.AddDevice(this.BootManager);
			this.SystemBusController.AddDevice(this.InterruptController);
			this.SystemBusController.AddDevice(this.RandomAccessMemoryController);
		}
