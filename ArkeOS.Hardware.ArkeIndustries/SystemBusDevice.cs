...
namespace ArkeOS.Hardware.ArkeIndustries {
    public abstract class SystemBusDevice : ISystemBusDevice {
        ...
        public virtual ulong ReadWord(ulong address) => 0;
        ...
        public virtual void Copy(ulong source, ulong destination, ulong length) => this.Write(destination, this.Read(source, length));
